<template>
  <div class="library-page">
    ...
    <!-- Empty State -->
    <div v-else-if="!plansStore.plans.length" class="empty-state">
    ...
    <div v-else class="library-content">
      ...
      <section v-if="plansStore.inactivePlans.length" class="saved-section">
        ...
        <div class="plans-grid">
          <PlanCard
            v-for="plan in plansStore.inactivePlans"
            :key="plan.id"
            :plan="plan"
            @set-active="handleActivatePlan"
            @view="handleViewPlan"
            @delete="handleDeletePlan"
          />
        </div>
      ...
      <section v-else class="empty-saved">
        <p>No saved plans. All your generated plans will appear here.</p>
      </section>
    </div>
